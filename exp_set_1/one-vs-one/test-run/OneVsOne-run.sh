...
FILE="/u/mandar/thesis-code/experimental_code/OneVsOneClassifier/OneVsOneClassifier.py"
EXP="exp_set_1:OneVsOne...TEST RUN"
THESIS="[THESIS-${HOSTNAME}-${EXP}"
proto_gen_method="ImprintS2Prototypes"
dataset_prefix="/u/mandar/thesis-images/one-vs-all/OneVsRestClassifier/"
